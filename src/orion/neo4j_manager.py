...
def clear_neo4j_for_new_run(uri: str = "neo4j://127.0.0.1:7687", 
                           user: str = "neo4j",
                           password: str = "orion123") -> bool:
    """
    ...
    if stats["nodes"] > 0 or stats["relationships"] > 0:
        logger.info(f"Found existing data: {stats['nodes']} nodes, {stats['relationships']} relationships")
