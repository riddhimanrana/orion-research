...
Usage:
    python -m orion.cli.pipelines.reid --episode test_validation --video data/examples/test.mp4
    python -m orion.cli.pipelines.reid --tracks results/test_validation/tracks.jsonl --video data/examples/test.mp4 --out results/test_validation
"""
