...
class ServiceDetector:
    ...
    def __init__(self):
        self.neo4j_uri = os.getenv("ORION_NEO4J_URI", "bolt://localhost:7687")
...
def status_command(args) -> int:
    ...
    config_table.add_row(".env File", "[green]✓ Present[/green]" if env_file.exists() else "[yellow]⚠ Missing[/yellow]")
