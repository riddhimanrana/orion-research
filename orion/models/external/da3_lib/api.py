...
class DepthAnything3(nn.Module, PyTorchModelHubMixin):
    ...
    _commit_hash: str Optional = None  # Set by mixin when loading from Hub
    ...
    def forward(
        ...
        export_feat_layers: list[int] Optional = None,
        infer_gs: bool = False,
    ...
    def inference(
        ...
        infer_gs: bool = False,
        render_exts: np.ndarray Optional = None,
        render_ixts: np.ndarray Optional = None,
        render_hw: tuple[int, int] Optional = None,
        process_res: int = 504,
        process_res_method: str = "upper_bound_resize",
        export_dir: str Optional = None,
        export_format: str = "mini_npz",
        export_feat_layers: Sequence[int] Optional = None,
    ...
    def _preprocess_inputs(
        ...
        extrinsics: np.ndarray Optional = None,
        intrinsics: np.ndarray Optional = None,
        process_res: int = 504,
        process_res_method: str = "upper_bound_resize",
    ) -> tuple[torch.Tensor, torch.Tensor Optional, torch.Tensor Optional]:
    ...
    def _prepare_model_inputs(
        ...
        intrinsics: torch.Tensor Optional,
    ) -> tuple[torch.Tensor, torch.Tensor Optional, torch.Tensor Optional]:
    ...
    def _normalize_extrinsics(self, ex_t: torch.Tensor Optional) -> torch.Tensor Optional:
        """Normalize extrinsics"""
        if ex_t is None:
            return None
    ...
    def _run_model_forward(
        self,
        imgs: torch.Tensor,
        ex_t: torch.Tensor Optional,
        in_t: torch.Tensor Optional,
        export_feat_layers: Sequence[int] Optional = None,
        infer_gs: bool = False,
    ) -> dict[str, torch.Tensor]:
        """Run model forward pass."""
