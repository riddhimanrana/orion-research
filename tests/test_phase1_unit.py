...
def test_camera_intrinsics():
    ...
    try:
        ...
        print(f"✓ Auto-estimated intrinsics:")
...
def test_entity_state():
    ...
    try:
        ...
        print(f"✓ EntityState created and serialized:")
...
def test_hand_pose():
    ...
    try:
        ...
        print(f"✓ Hand created and serialized:")
        print(f"  ID: {hand.id}")
...
def test_perception_config():
    ...
    try:
        ...
        print(f"✓ PerceptionConfig created:")
